...
2. `node_positions`: counts the number of times each node in a network occurs in each of the unique node positions within the motifs.  
    - **Unweighted**: counts the number of times each node in a network occurs in each of the unique node positions within the motifs.  
...
3. `link_positions`: 
    - **Unweighted**: counts the number of times each link in a network occurs in each of the unique link positions within the motifs.
    - **Weighted**: calculates the number of times each link in a network occurs in each of the unique link positions within the motifs, multiplied by each link's strength
