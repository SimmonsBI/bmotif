...
//[[Rcpp::export]]
List np_m2_ls (int NZ, int NP, NumericMatrix W) {
	NumericVector v3(NP);
	NumericVector v4(NZ);
	for (int x = 0; x < NZ; x++) {
		for (int p = 0; p < NP; p++) {
...
//[[Rcpp::export]]
List np_m3_ls (int NZ, int NP, NumericMatrix W) {
	NumericVector v5(NP);
	NumericVector v6(NZ);
	for (int p = 0; p < NP; p++) {
		for (int w = 0; w < NZ; w++) {
...
//[[Rcpp::export]]
List np_m4_ls (int NZ, int NP, NumericMatrix W) {
	NumericVector v7(NP);
	NumericVector v8(NZ);
	for (int p = 0; p < NP; p++) {
		for (int w = 0; w < NZ; w++) {
...
//[[Rcpp::export]]
List np_m5_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m6_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m7_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m8_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m9_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m10_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m11_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m12_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m13_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m14_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m15_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m16_ls (int NZ, int NP, NumericMatrix W) {
...
//[[Rcpp::export]]
List np_m17_ls (int NZ, int NP, NumericMatrix W) {
