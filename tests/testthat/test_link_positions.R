...
test_that("Test counts for the motif 18", {
  lr <- link_positions( motifs[[18]], six_node = TRUE)
  expect_equal(as.vector(lr[,30]), rep(1,5))
})

# motif 19
test_that("Test counts for the motif 19", {
  lr <- link_positions( motifs[[19]], six_node = TRUE)
...
# motif 20
test_that("Test counts for the motif 20", {
  lr <- link_positions( motifs[[20]], six_node = TRUE)
...
# motif 21
test_that("Test counts for the motif 21", {
  lr <- link_positions( motifs[[21]], six_node = TRUE)
...
# motif 22
test_that("Test counts for the motif 22", {
  lr <- link_positions( motifs[[22]], six_node = TRUE)
...
# motif 23
test_that("Test counts for the motif 23", {
  lr <- link_positions( motifs[[23]], six_node = TRUE)
...
# motif 24
test_that("Test counts for the motif 24", {
  lr <- link_positions( motifs[[24]], six_node = TRUE)
...
# motif 25
test_that("Test counts for the motif 25", {
  lr <- link_positions( motifs[[25]], six_node = TRUE)
...
test_that("Test counts for the motif 26", {
  lr <- link_positions( motifs[[26]], six_node = TRUE)
...
test_that("Test counts for the motif 27", {
  lr <- link_positions( motifs[[27]], six_node = TRUE)
...
test_that("Test counts for the motif 28", {
  lr <- link_positions( motifs[[28]], six_node = TRUE)
...
test_that("Test counts for the motif 29", {
  lr <- link_positions( motifs[[29]], six_node = TRUE)
...
test_that("Test counts for the motif 30", {
  lr <- link_positions( motifs[[30]], six_node = TRUE)
...
test_that("Test counts for the motif 31", {
  lr <- link_positions( motifs[[31]], six_node = TRUE)
...
test_that("Test counts for the motif 32", {
  lr <- link_positions( motifs[[32]], six_node = TRUE)
...
test_that("Test counts for the motif 33", {
  lr <- link_positions( motifs[[33]], six_node = TRUE)
...
test_that("Test counts for the motif 34", {
  lr <- link_positions( motifs[[34]], six_node = TRUE)
  expect_equal(as.vector(lr[,81]), rep(1,6))
})

test_that("Test counts for the motif 35", {
  lr <- link_positions( motifs[[35]], six_node = TRUE)
...
test_that("Test counts for the motif 36", {
  lr <- link_positions( motifs[[36]], six_node = TRUE)
...
test_that("Test counts for the motif 37", {
  lr <- link_positions( motifs[[37]], six_node = TRUE)
  expect_equal(as.vector(lr[,89]), rep(1,9))
})

# motif 38
test_that("Test counts for the motif 38", {
  lr <- link_positions( motifs[[38]], six_node = TRUE)
...
test_that("Test counts for the motif 39", {
  lr <- link_positions( motifs[[39]], six_node = TRUE)
...
# motif 40
test_that("Test counts for the motif 40", {
  lr <- link_positions( motifs[[40]], six_node = TRUE)
...
# motif 41
test_that("Test counts for the motif 41", {
  lr <- link_positions( motifs[[41]], six_node = TRUE)
...
# motif 42
test_that("Test counts for the motif 42", {
  lr <- link_positions( motifs[[42]], six_node = TRUE)
...
# motif 43
test_that("Test counts for the motif 43", {
  lr <- link_positions( motifs[[43]], six_node = TRUE)
  expect_equal(as.vector(lr[,105]), c(rep(1,8)))
})

# motif 44
test_that("Test counts for the motif 44", {
  lr <- link_positions( motifs[[44]], six_node = TRUE)
...
test_that("Test counts for the motifs with 4 nodes", {
  lr <- link_positions(bm4, six_node = TRUE)
  rownames(lr) <- c()
  colnames(lr) <- c()
...
test_that("Test counts for the motifs with 5 nodes", {
  lr <- link_positions(bm5, six_node = TRUE)
  rownames(lr) <- c()
  colnames(lr) <- c()
...
test_that("Test counts for the motifs with 6 nodes", {
  lr <- link_positions(bm6, six_node = TRUE)
  rownames(lr) <- c()
  colnames(lr) <- c()
...
test_that("Test normalised counts for the motif 4", {
  lr <- link_positions( motifs[[4]], normalisation = "sum" )
  ...
  lr <- link_positions( motifs[[4]], normalisation = "position" )
...
test_that("Test normalised counts for the motif 6", {
  lr <- link_positions( motifs[[6]], normalisation = "sum" )
...
test_that("Test normalised counts for the motif 9", {
  lr <- link_positions( motifs[[9]], normalisation = "sum", six_node = TRUE )
  ...
  lr <- link_positions( motifs[[9]], normalisation = "position")
  ...
  expect_equal( as.vector(lr[,5]), c(0,0, 0, 1))
  expect_equal( as.vector(lr[,9]), c(0,0, 0, 0))
})